...
export interface VanillaModel { parent?:string; textures?:Record<string,string>; elements?:ModelElement[]; ambientocclusion?:boolean; display?:Record<string,{rotation?:Vec3;translation?:Vec3;scale?:Vec3}> }
